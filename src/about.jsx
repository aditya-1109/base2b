...
const About = () => {
  ...
  return (
    ...
    <motion.div
      ...
      className="mt-24"
    >
      <h2 className="text-3xl md:text-4xl font-semibold text-center mb-10">Our History</h2>
      
      {/* Timeline Card */}
      <div className="flex flex-col md:flex-row justify-between items-center gap-10">
        {/* Left */}
        <div className="text-center md:text-left">
          <h4 className="text-lg font-semibold mb-1">World Interior Decor</h4>
          <p className="text-gray-300">2021</p>
        </div>

        {/* Card Content */}
        <div className="border border-gray-600 p-6 rounded-md max-w-xl w-full bg-black text-white">
          <h5 className="text-lg font-semibold mb-2">
            World Interior Decor: Elevating Spaces with Elegance.
          </h5>
          <p className="text-sm text-gray-300">
            We have been working with WID for more than 2 years. Our dedicated web development, design, and SEO expertise transformed World Interior Decor into a premier destination for curtains, drapes, and blinds, making interior aesthetics standout.
          </p>
        </div>
